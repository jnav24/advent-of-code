...
func main() {
	fmt.Println(getPartOneSolution(getTestPuzzleDataOne()))
	// => 142

	fmt.Println(getPartOneSolution(getPuzzleData()))
	// => 55538

	fmt.Println(getPartTwoSolution(getTestPuzzleDataTwo()))
	// => 281

	fmt.Println(getPartTwoSolution(getPuzzleData()))
	// => 54875
}

func getPartOneSolution(list []string) int {
	total := 0

	for _, item := range list {
		num, _ := strconv.Atoi(getNumberFromString(removeSpaces(item)))
		total = total + num
	}
...
func getPartTwoSolution(list []string) int {
	...
	for _, item := range list {
		num, _ := strconv.Atoi(getNumberFromString(replaceNumbersWithDigits(removeSpaces(item))))
		total = total + num
	}
...
func getTestPuzzleDataOne() []string {
	data := `
		1abc2
		pqr3stu8vwx
		a1b2c3d4e5f
...
func getTestPuzzleDataTwo() []string {
	data := `
		two1nine
		eightwothree
		abcone2threexyz
