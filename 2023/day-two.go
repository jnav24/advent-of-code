...
func main() {
	fmt.Println(partOneResults(getPartOneTestData()))
	// => 8

	fmt.Println(partOneResults(getPartOneData()))
	//=> 2632

	fmt.Println(partTwoResults(getPartOneTestData()))
	// => 2286
...
func getPartOneTestData() []string {
	data := `
